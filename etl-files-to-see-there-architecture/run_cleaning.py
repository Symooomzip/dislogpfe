"""
Run the ETL cleaning pipeline: load raw CSVs, validate, clean, apply RI, log metrics.
Output: clean DataFrames in memory (and optionally write to Data/cleaned/ for inspection).
Usage: python -m etl.run_cleaning
"""
import logging
import sys
