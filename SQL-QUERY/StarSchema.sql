...
CREATE TABLE DimCustomer (
    ...
    -- ML / analytics fields (filled in Phase 3+)
    Segment        NVARCHAR(50),
    ChurnRisk      FLOAT,
...
CREATE TABLE FactSales (
    ...
    -- Header amounts denormalized at line level for analytics
    HeaderBruteAmount DECIMAL(18, 2),
    HeaderNetAmount   DECIMAL(18, 2),
    HeaderTaxAmount   DECIMAL(18, 2),
    HeaderTotalAmount DECIMAL(18, 2)
);

-- Helpful indexes for analytics workloads (Power BI / ROLAP)
